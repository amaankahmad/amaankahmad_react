  ...
  return (
    <section className="sm:mx-4 sm:my-4 xl:mx-4 xl:my-8 mt-12 md:mt-20 xl:mt-32 text-center text-white">
      ...
      <div className="mt-4 md:mb-16 xl:my-12 xl:mb-24 2xl:mt-[6%]">
        <div className="bg-[#E7DFD5] w-full h-36 md:h-40 xl:h-48">
          ...
          <div className="flex items-center justify-center md:gap-20 xl:gap-36 xs:space-x-3 sm:space-x-8 md:space-x-0">
            <img
              alt="st pauls logo"
              src={StPaulsLogo}
